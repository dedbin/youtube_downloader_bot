    ...
    try:
        ...
        if mode == 'high_quality':
            try:
                ...
                merge_video_audio(
                    video_file=f'C:/Users/red1c/youtube_downloader/video/{message.chat.id}_{mess_time}.mp4',
                ...
                with open(f'C:/Users/red1c/youtube_downloader/video/finished_video_{message.chat.id}_{mess_time}.mp4',
                          'rb') as video:
                    ...
                    os.remove(
                        f'C:/Users/red1c/youtube_downloader/video/finished_video_{message.chat.id}_{mess_time}.mp4')
